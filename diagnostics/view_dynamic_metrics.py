...
from train_Transformer import ASLTransformerClassifier, DynamicASLDataset, FEATURE_DIM, SEQUENCE_LENGTH
...
def main():
    ...
    # Reports
    print("\n --- ASL Dynamic Transformer Evaluation Report ---")
    ...
    plt.title("ASL Dynamic Transformer Confusion Matrix")
    plt.xlabel("Predicted Sign")
    plt.ylabel("True Sign")
    plt.tight_layout()
    
    out_fig = PROJECT_ROOT / "diagnostics" / "dynamic_confusion_matrix.png"
    plt.savefig(out_fig)
    print(f"✓ Saved Confusion Matrix plot to '{out_fig.resolve()}'")
